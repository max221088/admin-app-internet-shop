<template>
  <div class="container wrop-manager">
    ...
    data-bs-target="#exampleModaAddNewCat" type="submit">
      Add new Category
    </button>
    <div class="categories-table">
      ...
      <div class="row mt-1" v-for="category, index in categories" :key="index">
        ...
        <div class="col-3">
          ...
          data-bs-toggle="modal" data-bs-target="#exampleModaAddProd">
            Add product to category
          </button>
        </div>
        <div class="col-3">
          <button  class="btn btn-primary mr-md-2 btn-danger" type="button" 
          @click="getDelCat(index)" data-bs-toggle="modal" data-bs-target="#exampleModaDelCat">
            Delete
          </button>
        </div>
      </div>
