  ...
  <div class="wrop container">
    ...
    <div class=" container">
      <div class="row">
        <div class="col-8">
          ...
          <div class="row">
            ...
            <div class="col-9">
              <textarea class="form-control" id="exampleFormControlTextarea1" 
                style="resize:none;" rows="1" v-model="editProduct.order">
              </textarea>
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-7" v-if="editProduct.category">
              <div class="cat-container">
                <span v-for="cat, index in catProduct" :key="index" :data-id="cat.id">
                  {{ cat.title }}, 
                </span>
              </div>   
            </div>
          ...
          <div class="row">
            ...
            <div class="col-3" v-if="!!editProduct.price">
              <textarea 
                ...
                rows="1" v-model="editProduct.price.value">
              </textarea>  
            </div>
          ...
          <div class="row">
            ...
            <div class="col-6">
              <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                <button @click="startUploadGallary" class="btn btn-primary mr-md-2" type="button">
                  Add Gallery
                </button>
                <button @click="startUpload" class="btn btn-primary mr-md-2" type="button">
                  Add avatar
                </button>
              </div>
              <input type="file" 
      ...
      <div class="row">
        ...
        <div class="col-10" v-if="editProduct.id" id="app">
          <JoditEditor v-model="editProduct.description" :buttons="buttons"/>
        </div>
      </div>
      <div class="row">
        <div clas="col-10">
          ...
          <button  type="button" 
            class="btn btn-secondary btn-lg" @click="onCancel">
            Cancel
          </button>
        </div>
      </div>
